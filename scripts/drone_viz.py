...
def getMeshMarker(id, pnt):
    ...
    _model_marker.color.g = 0.0
    _model_marker.color.b = 1.0

    _model_marker.pose.position.x = pnt.x
    _model_marker.pose.position.y = pnt.y
    _model_marker.pose.position.z = pnt.z
    ...
    _model_marker.mesh_resource = "package://drone_env_viz/mesh/quad_base.stl"
...
class DroneViz(object):
    ...
    def callback_trajectory(self, msg):
        ...
        stagged_pnts = [msg.points[0]] + msg.points[::10]    
    ...
    def __build_rendering(self):
        ...
        self._traj_msg.color.r = 0.0
        self._traj_msg.color.g = 1.0
        self._traj_msg.color.b = 0.5
